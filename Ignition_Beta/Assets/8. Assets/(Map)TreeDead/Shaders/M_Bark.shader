Shader "Unreal/M_Bark"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Bark_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Bark_Height", 2D ) = "white" {}
		Material_Texture2D_2( "T_Bark_BaseColor", 2D ) = "white" {}
		Material_Texture2D_3( "T_Bark_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Bark_AmbientOcclusion", 2D ) = "white" {}
