Shader "Unreal/MI_Signs_Decals_Black"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Signs_Color", 2D ) = "white" {}
		Material_Texture2D_1( "T_Signs_Alpha", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_Signs_Decals_Black.hlsl"
