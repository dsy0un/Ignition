...
{
	Material.PreshaderBuffer[0] = float4(4.814392,1.587000,1.454064,1.236537);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.158700,0.145406,0.123654,0.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local12 = (View.GameTime * Material.PreshaderBuffer[1].w);
	MaterialFloat Local13 = frac(Local12);
	MaterialFloat Local14 = round(DERIV_BASE_VALUE(Local13));
	MaterialFloat3 Local15 = (Local11 * ((MaterialFloat3)Local14));
	MaterialFloat3 Local16 = select((Material.PreshaderBuffer[1].w >= 0.00100000), Local15, Local11);
	MaterialFloat3 Local17 = lerp(Local16,Material.PreshaderBuffer[2].yzw,Material.PreshaderBuffer[2].x);
