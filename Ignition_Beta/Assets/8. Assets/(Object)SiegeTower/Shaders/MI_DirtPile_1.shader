Shader "Unreal/MI_DirtPile_1"
{
    Properties
    {
		...
		Material_Texture2D_1( "T_Soil_normal", 2D ) = "white" {}
		Material_Texture2D_2( "T_Soil_basecolor", 2D ) = "white" {}
		Material_Texture2D_3( "T_Soil_height", 2D ) = "white" {}
		Material_Texture2D_4( "OverlayTexture", 2D ) = "white" {}
		Material_Texture2D_5( "T_Soil_roughness", 2D ) = "white" {}
		Material_Texture2D_6( "Good64x64TilingNoiseHighFreq", 2D ) = "white" {}
		Material_Texture2D_7( "T_Soil_ambientocclusion", 2D ) = "white" {}
