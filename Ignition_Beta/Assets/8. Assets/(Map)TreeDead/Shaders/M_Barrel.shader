Shader "Unreal/M_Barrel"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Barrel_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Barrel_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Barrel_Metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_Barrel_Roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Barrel_AO", 2D ) = "white" {}
