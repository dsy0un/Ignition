...
{
	Material.PreshaderBuffer[0] = float4(1.000000,0.010000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[3] = float4(1.000000,1.000000,1.002000,0.000200);//(Unknown)
