Shader "Unreal/M_Dragon"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Dragon_DefaultMaterial_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Dragon_DefaultMaterial_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Dragon_DefaultMaterial_OcclusionRoughnessMetallic", 2D ) = "white" {}
