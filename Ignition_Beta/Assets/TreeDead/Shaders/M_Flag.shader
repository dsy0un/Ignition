Shader "Unreal/M_Flag"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Flag_Flag_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Flag_Flag_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Flag_Flag_OcclusionRoughnessMetallic", 2D ) = "white" {}
