Shader "Unreal/MI_TrimMetallic"
{
    Properties
    {
		...
		Material_Texture2D_2( "Diffuse", 2D ) = "white" {}
		Material_Texture2D_3( "Metaliic", 2D ) = "white" {}
		Material_Texture2D_4( "T_GrungeMask", 2D ) = "white" {}
		Material_Texture2D_5( "Roughness", 2D ) = "white" {}
		Material_Texture2D_6( "Alpha", 2D ) = "white" {}
		Material_Texture2D_7( "AO", 2D ) = "white" {}
