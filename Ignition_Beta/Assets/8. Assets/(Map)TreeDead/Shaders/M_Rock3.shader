Shader "Unreal/M_Rock3"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Rock3_normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Rock3_albedo", 2D ) = "white" {}
		Material_Texture2D_2( "T_Rock3_metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_Rock3_roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Rock3_AO", 2D ) = "white" {}
