Shader "Unreal/MI_WaterPlane_Inst"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_BubblesNormal", 2D ) = "white" {}
		Material_Texture2D_1( "T_PerlinGradientMapNormal", 2D ) = "white" {}
		Material_Texture2D_2( "T_PerlinGradientMap", 2D ) = "white" {}
		Material_Texture2D_3( "T_WaterDirt_height", 2D ) = "white" {}
		Material_Texture2D_4( "T_WaterFoam", 2D ) = "white" {}
		Material_Texture2D_5( "T_WaterDirt_basecolor", 2D ) = "white" {}
		Material_Texture2D_6( "T_CloudNoise", 2D ) = "white" {}
		Material_Texture2D_7( "DirtPuddles", 2D ) = "white" {}
		Material_Texture2D_8( "T_WaterDirt_roughness", 2D ) = "white" {}
		Material_Texture2D_9( "T_WaterDirt_ambientocclusion", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_WaterPlane_Inst.hlsl"
