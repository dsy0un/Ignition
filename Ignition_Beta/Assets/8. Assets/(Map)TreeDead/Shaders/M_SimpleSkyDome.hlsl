...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = MaterialExpressionSkyAtmosphereViewLuminance(Parameters);
	MaterialFloat3 Local1 = MaterialExpressionSkyAtmosphereLightDiskLuminance(Parameters, 0, -1.00000000);
	MaterialFloat3 Local2 = (Local0 + Local1);
	MaterialFloat3 Local3 = lerp(Local2,Material.PreshaderBuffer[0].yzw,Material.PreshaderBuffer[0].x);
