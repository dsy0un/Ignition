...
{
	Material.PreshaderBuffer[0] = float4(0.215861,0.215861,1.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.595833,0.595833,0.595833,1.000000);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	PixelMaterialInputs.Normal = Material.PreshaderBuffer[0].xyz;
	...
	MaterialFloat3 Local0 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.PreshaderBuffer[1].xyz,Material.PreshaderBuffer[0].w);
	...
	MaterialFloat3 Local5 = (Local3.rgb * Material.PreshaderBuffer[2].xyz);
	MaterialFloat Local6 = dot(Local5,MaterialFloat3(0.30000001,0.58999997,0.11000000));
	MaterialFloat3 Local7 = lerp(Local5,((MaterialFloat3)Local6),Material.PreshaderBuffer[2].w);
	MaterialFloat4 Local8 = Parameters.VertexColor;
	MaterialFloat3 Local9 = DERIV_BASE_VALUE(Local8).rgb;
	MaterialFloat3 Local10 = (Local7 * DERIV_BASE_VALUE(Local9));
	MaterialFloat3 Local11 = max(Local10,((MaterialFloat3)0.05000000));
	MaterialFloat3 Local12 = min(Local11,((MaterialFloat3)0.94999999));
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local14 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
	MaterialFloat Local15 = MaterialStoreTexSample(Parameters, Local14, 0);

	PixelMaterialInputs.EmissiveColor = Local0;
	PixelMaterialInputs.Opacity = Local14.r;
