Shader "Unreal/M_Swing"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Swing_Swing_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Swing_Swing_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Swing_Swing_OcclusionRoughnessMetallic", 2D ) = "white" {}
