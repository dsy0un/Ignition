Shader "Unreal/MI_GraphicalDecals"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_GraphicDecals_1_Curvature", 2D ) = "white" {}
		Material_Texture2D_1( "T_GraphicDecals_1_basecolor", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_GraphicalDecals.hlsl"
