Shader "Unreal/MI_Mineral_1"
{
    Properties
    {
		...
		Material_Texture2D_0( "NormalBase", 2D ) = "white" {}
		Material_Texture2D_1( "Normal_1", 2D ) = "white" {}
		Material_Texture2D_2( "Normal_2", 2D ) = "white" {}
		Material_Texture2D_3( "Curvature", 2D ) = "white" {}
		Material_Texture2D_4( "AOBase", 2D ) = "white" {}
		Material_Texture2D_5( "SecondaryMask", 2D ) = "white" {}
		Material_Texture2D_6( "Diffuse", 2D ) = "white" {}
		Material_Texture2D_7( "Diffuse_2", 2D ) = "white" {}
		Material_Texture2D_8( "Roughness_1", 2D ) = "white" {}
		Material_Texture2D_9( "Roughness_2", 2D ) = "white" {}
		Material_Texture2D_10( "AO", 2D ) = "white" {}
		Material_Texture2D_11( "AO_2", 2D ) = "white" {}
