...
{
	Material.PreshaderBuffer[0] = float4(1.000000,0.793500,0.648026,0.429813);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.793500,0.648026,0.429813,0.000000);//(Unknown)
