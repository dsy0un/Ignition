Shader "Unreal/M_Firepit"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Firepit_Firepit_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Firepit_Firepit_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_Firepit_Firepit_OcclusionRoughnessMetallic", 2D ) = "white" {}
