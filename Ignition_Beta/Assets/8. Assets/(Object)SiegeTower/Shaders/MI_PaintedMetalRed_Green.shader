Shader "Unreal/MI_PaintedMetalRed_Green"
{
    Properties
    {
		...
		Material_Texture2D_2( "T_GrungeMask", 2D ) = "white" {}
		Material_Texture2D_3( "LeakingGrunge", 2D ) = "white" {}
		Material_Texture2D_4( "DirtTexture", 2D ) = "white" {}
		Material_Texture2D_5( "TopGrungeTexture", 2D ) = "white" {}
		Material_Texture2D_6( "T_PaintedMetal_metallic", 2D ) = "white" {}
		Material_Texture2D_7( "T_PaintedMetal_roughness", 2D ) = "white" {}
		Material_Texture2D_8( "T_PaintedMetal_ambientocclusion", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_PaintedMetalRed_Green.hlsl"
