Shader "Unreal/M_bucket"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_bucket_bucket_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_bucket_bucket_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_bucket_bucket_OcclusionRoughnessMetallic", 2D ) = "white" {}
