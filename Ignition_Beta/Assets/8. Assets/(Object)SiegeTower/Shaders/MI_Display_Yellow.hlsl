...
{
	Material.PreshaderBuffer[0] = float4(0.000000,0.500000,0.491797,0.401563);//(Unknown)
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local1 = frac(Local0);
	MaterialFloat Local2 = round(DERIV_BASE_VALUE(Local1));
	MaterialFloat3 Local3 = (Material.PreshaderBuffer[0].yzw * ((MaterialFloat3)Local2));
	MaterialFloat3 Local4 = select((Material.PreshaderBuffer[0].x >= 0.00100000), Local3, Material.PreshaderBuffer[0].yzw);
	...
	MaterialFloat4 Local7 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0,samplerMaterial_Texture2D_0,DERIV_BASE_VALUE(Local5),View.MaterialTextureMipBias));
	MaterialFloat Local8 = MaterialStoreTexSample(Parameters, Local7, 0);
	MaterialFloat3 Local9 = (Local4 * Local7.rgb);
	MaterialFloat3 Local10 = lerp(Local9,Material.PreshaderBuffer[1].yzw,Material.PreshaderBuffer[1].x);
