Shader "Unreal/MI_DecalsColor2_Flicker"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_HardDecals_Normal_OpenGL", 2D ) = "white" {}
		Material_Texture2D_1( "T_HardDecals_Emissive", 2D ) = "white" {}
		Material_Texture2D_2( "T_HardDecals_Base_Color", 2D ) = "white" {}
		Material_Texture2D_3( "T_HardDecals_Metallic", 2D ) = "white" {}
		Material_Texture2D_4( "T_HardDecals_Roughness", 2D ) = "white" {}
		Material_Texture2D_5( "T_HardDecals_Opacity", 2D ) = "white" {}
		Material_Texture2D_6( "T_HardDecals_Mixed_AO", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_DecalsColor2_Flicker.hlsl"
