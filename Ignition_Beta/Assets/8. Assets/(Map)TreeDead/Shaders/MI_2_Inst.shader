Shader "Unreal/MI_2_Inst"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_1_DefaultMaterial_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_1_DefaultMaterial_Emissive", 2D ) = "white" {}
		Material_Texture2D_2( "T_1_DefaultMaterial_BaseColor", 2D ) = "white" {}
		Material_Texture2D_3( "T_1_DefaultMaterial_OcclusionRoughnessMetallic", 2D ) = "white" {}
