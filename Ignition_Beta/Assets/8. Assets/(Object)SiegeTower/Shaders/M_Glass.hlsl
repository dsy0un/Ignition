...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local5 = dot(Local2.rgb,Parameters.CameraVector);
	MaterialFloat Local6 = max(0.00000000,Local5);
	MaterialFloat Local7 = (1.00000000 - Local6);
	MaterialFloat Local8 = abs(Local7);
	MaterialFloat Local9 = max(Local8,0.00010000);
	MaterialFloat Local10 = PositiveClampedPow(Local9,0.10000000);
	MaterialFloat Local11 = (Local10 * (1.00000000 - 0.04000000));
	MaterialFloat Local12 = (Local11 + 0.04000000);
	...
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat2(Local12,0.0f),Material.PreshaderBuffer[1].x);
