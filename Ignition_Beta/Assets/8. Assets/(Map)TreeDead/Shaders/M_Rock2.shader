Shader "Unreal/M_Rock2"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Rock2_normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Rock2_albedo", 2D ) = "white" {}
		Material_Texture2D_2( "T_Rock2_metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_Rock2_roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Rock2_AO", 2D ) = "white" {}
