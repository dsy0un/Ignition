...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(3.000000,2.796144,2.475000,0.038400);//(Unknown)
	Material.PreshaderBuffer[4] = float4(3.314550,-2.314550,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(0.030000,0.030000,0.030000,0.910400);//(Unknown)
	Material.PreshaderBuffer[6] = float4(0.168000,0.000000,1.000000,0.500000);//(Unknown)
}
