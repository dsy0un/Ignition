Shader "Unreal/M_torch"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_torch_torch_Normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_torch_torch_BaseColor", 2D ) = "white" {}
		Material_Texture2D_2( "T_torch_torch_OcclusionRoughnessMetallic", 2D ) = "white" {}
