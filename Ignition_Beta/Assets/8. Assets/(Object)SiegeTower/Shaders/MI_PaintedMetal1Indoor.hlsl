...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.862500,0.838350,0.765900,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(1.200000,1.147500,1.050000,0.448609);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.691667,0.661597,0.602326,0.193474);//(Unknown)
	Material.PreshaderBuffer[4] = float4(0.121600,-0.019200,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[7] = float4(0.359510,0.257198,0.191143,0.000000);//(Unknown)
	Material.PreshaderBuffer[8] = float4(0.000000,0.000000,0.000000,0.083950);//(Unknown)
	Material.PreshaderBuffer[9] = float4(2.000000,256.000000,256.000000,256.000000);//(Unknown)
	Material.PreshaderBuffer[10] = float4(0.400000,0.400000,0.400000,0.365500);//(Unknown)
	Material.PreshaderBuffer[11] = float4(0.339875,0.428800,1.171515,-0.171515);//(Unknown)
	...
	Material.PreshaderBuffer[15] = float4(0.416667,0.396759,0.371529,0.000000);//(Unknown)
