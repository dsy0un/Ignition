Shader "Unreal/M_Rock"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_Rock_normal", 2D ) = "white" {}
		Material_Texture2D_1( "T_Rock_albedo", 2D ) = "white" {}
		Material_Texture2D_2( "T_Rock_metallic", 2D ) = "white" {}
		Material_Texture2D_3( "T_Rock_roughness", 2D ) = "white" {}
		Material_Texture2D_4( "T_Rock_AO", 2D ) = "white" {}
