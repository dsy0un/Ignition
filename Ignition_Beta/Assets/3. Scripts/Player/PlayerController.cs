...
public class PlayerController : MonoBehaviour, IHitAble
{
    ...
    void FixedUpdate()
    {
        float distanceFromFloor = Vector3.Dot(mainCamera.transform.localPosition, Vector3.up);
        transform.localPosition = new Vector3(mainCamera.transform.localPosition.x * distanceFromFloor, 0, mainCamera.transform.localPosition.z * distanceFromFloor);
